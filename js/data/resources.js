...
window.DAI_RESOURCES = [
  ...
  { id: "wes-stormheart-1", name: "Stormheart", region: "western_approach", category: "metal", rarity: "rare", tier: 3, x: 0.55, y: 0.30, desc: "Tier-3 metal — lightning-aspect crafting.", source: "Mining ridges along the canyons; densest at Echo Back Canyon and the cliffs surrounding Coracavus.", tags: ["mining","tier3","stormheart"] },
  ...
  { id: "emp-dragon-highland", name: "Highland Ravager", region: "emprise_du_lion", category: "dragon", rarity: "unique", x: 0.80, y: 0.20, desc: "Level 23 high dragon (cold) — strongest base-game dragon.", source: "Cradle of Sulevin / north-east Emprise. Requires three trebuchet camps cleared in 'Capture Suledin Keep' to access the path.", tags: ["dragon","endgame","sulevin"] },
  ...
  // ============================================================
  { id: "lm-hin-calenhad",     name: "Calenhad's Foothold",          region: "hinterlands",      category: "landmark", rarity: "common", x: 0.48, y: 0.62, desc: "Old border watch — Inquisition observation point.", source: "South of the Crossroads on the Calenhad slope.", tags: ["landmark","influence"] },
  { id: "lm-hin-luthias",      name: "Lake Luthias overlook",        region: "hinterlands",      category: "landmark", rarity: "common", x: 0.36, y: 0.40, desc: "View over the Hinterlands lake.", source: "Hilltop north-west of Lake Luthias.", tags: ["landmark","influence"] },
  { id: "lm-sto-driftwood",    name: "Driftwood Margin",             region: "storm_coast",      category: "landmark", rarity: "common", x: 0.42, y: 0.50, desc: "Northern landing beach.", source: "Northern coast, near the camp shoreline.", tags: ["landmark","influence"] },
  { id: "lm-sto-lighthouse",   name: "The Salt Flats / Lighthouse",  region: "storm_coast",      category: "landmark", rarity: "common", x: 0.38, y: 0.32, desc: "Old beacon ruin.", source: "North-west cliff path, past the templar camp.", tags: ["landmark","influence"] },
  { id: "lm-cre-old-crest",    name: "The Drowned Town of Crestwood",region: "crestwood",        category: "landmark", rarity: "common", x: 0.40, y: 0.55, desc: "Visible only after Still Waters drains the lake.", source: "Lake bed once emptied; central Crestwood basin.", tags: ["landmark","influence","post-drain"] },
  { id: "lm-cre-bronach",      name: "Caer Bronach battlement",      region: "crestwood",        category: "landmark", rarity: "common", x: 0.72, y: 0.20, desc: "Reclaimed Inquisition keep.", source: "Atop the keep after capture.", tags: ["landmark","influence"] },
  { id: "lm-fal-hargol",       name: "Hargol's Stronghold",          region: "fallow_mire",      category: "landmark", rarity: "common", x: 0.72, y: 0.40, desc: "Avvar fortress.", source: "Inside the fortress courtyard after defeating the Hand.", tags: ["landmark","influence","avvar"] },
  { id: "lm-wes-coracavus",    name: "Coracavus prison-fort",        region: "western_approach", category: "landmark", rarity: "common", x: 0.66, y: 0.32, desc: "Tevinter prison ruin.", source: "Eastern Western Approach, on the rim of the canyon.", tags: ["landmark","influence","tevinter"] },
  { id: "lm-wes-bridge",       name: "The Forgotten Sea bridge",     region: "western_approach", category: "landmark", rarity: "common", x: 0.42, y: 0.55, desc: "Span over the great salt waste.", source: "Mid-map, on the bridge between Lost Spring and Echo Back.", tags: ["landmark","influence"] },
  { id: "lm-exa-citadelle",    name: "Citadelle du Corbeau parapet", region: "exalted_plains",   category: "landmark", rarity: "common", x: 0.55, y: 0.20, desc: "Vantage over the battlefields.", source: "Topmost walkway after liberating the citadelle.", tags: ["landmark","influence"] },
  { id: "lm-eme-watchers",     name: "Watcher's Reach summit",       region: "emerald_graves",   category: "landmark", rarity: "common", x: 0.50, y: 0.25, desc: "Highest point in the Graves.", source: "Climb path through the giants' clearings.", tags: ["landmark","influence"] },
  { id: "lm-emp-suledin",      name: "Suledin Keep ramparts",        region: "emprise_du_lion",  category: "landmark", rarity: "common", x: 0.65, y: 0.38, desc: "Inquisition flag raised.", source: "Top of the keep after liberation.", tags: ["landmark","influence"] },
  { id: "lm-his-fairel",       name: "The Tomb of Fairel",           region: "hissing_wastes",   category: "landmark", rarity: "common", x: 0.55, y: 0.45, desc: "Ancestral dwarven crypt.", source: "Central Hissing Wastes after activating the four obelisks.", tags: ["landmark","influence","tombs"] },
  { id: "lm-his-stones",       name: "The Sand-Reaver burial stones",region: "hissing_wastes",   category: "landmark", rarity: "common", x: 0.30, y: 0.60, desc: "Standing-stone field.", source: "South-west sands.", tags: ["landmark","influence"] },
  { id: "lm-fro-hakkon-peak", name: "Hakkon's Peak vantage",        region: "frostback_basin",  category: "landmark", rarity: "common", x: 0.50, y: 0.18, desc: "Avvar holy summit.", source: "Northern peak, above the basin.", tags: ["landmark","influence","dlc"] },
